...
class UserController extends Controller
{
    ...
    {
        return UserControllerService::get_sale_off_products_or_products_or_latest_products(product_name:$product_name, product_category:$product_category, product_price:$product_price, product_color:$product_color, product_size:$product_size, sort_type:$sort_type);
    }

    public function get_latest_products2($product_name, $product_category, $product_price, $product_color, $product_size)
    {
        return UserControllerService::get_sale_off_products_or_products_or_latest_products(product_name:$product_name, product_category:$product_category, product_price:$product_price, product_color:$product_color, product_size:$product_size);
    }
